...
app.get('/goat/:name', function(req, res) {

    var name = req.param('name');

    var found = _.find(goats, {name: name});

    res.send(found);
});


app.get('/goats/search/:term', function(req, res) {

    var term = req.param('term');

    var found = _.filter(goats, function(goat) {
        return _.contains((goat.name + goat.alt + goat.origin + goat.purpose).toUpperCase(), term.toUpperCase());
    });
